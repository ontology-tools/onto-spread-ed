...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  var _hoisted_1 = { class: "collapsible-card" };
  ...
  CollapsibleCard_default.render = render;
  ...
  // sfc-script:/home/bjoern/development/onto-spread-ed/js/settings/Settings.vue?type=script
  var Settings_default = /* @__PURE__ */ defineComponent({
    ...
    setup(__props, { expose: __expose }) {
      ...
      let deleting = ref(null);
      let startupChanging = ref(null);
      let blocked = computed2(() => loading.value || deleting.value !== null || startupChanging.value !== null);
      async function toggleStartup(repo) {
        ...
        if (resp.success) {
          settings.value.startup_repositories = currentlySet ? settings.value.startup_repositories.filter((x) => x !== repo.full_name) : [...settings.value.startup_repositories, repo.full_name];
        } else {
          await alertDialog({
      ...
      async function unloadRepository(repo) {
      ...
      async function loadRepository() {
        ...
        if (resp.success) {
          ...
          const index = await promptDialog({
            ...
            message: `Chose one of your repositories to load.`,
            inputType: "select",
      ...
      const __returned__ = { prefix_url, settings, get loading() {
        return loading;
      }, set loading(v) {
        loading = v;
      }, get deleting() {
        ...
        return startupChanging;
      }, set startupChanging(v) {
        startupChanging = v;
      }, get blocked() {
        return blocked;
      }, set blocked(v) {
        blocked = v;
      }, toggleStartup, unloadRepository, loadRepository, CollapsibleCard: CollapsibleCard_default2 };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  });

  // sfc-style:/home/bjoern/development/onto-spread-ed/js/settings/Settings.vue?type=style&index=0
  {
    const el = document.createElement("style");
    el.textContent = ".settings[data-v-048866bb] {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n}";
    document.head.append(el);
  }

  // sfc-template:/home/bjoern/development/onto-spread-ed/js/settings/Settings.vue?type=template
  var _hoisted_12 = { class: "settings" };
  var _hoisted_22 = ["onClick", "disabled"];
  var _hoisted_32 = ["onClick", "disabled"];
  var _hoisted_42 = { class: "input-group input-group-sm mb-3" };
  var _hoisted_5 = ["onUpdate:modelValue"];
  var _hoisted_6 = { class: "input-group input-group-sm mb-3" };
  var _hoisted_7 = ["onUpdate:modelValue"];
  var _hoisted_8 = { class: "input-group input-group-sm mb-3" };
  var _hoisted_9 = ["onUpdate:modelValue"];
  var _hoisted_10 = { class: "input-group input-group-sm mb-3" };
  var _hoisted_11 = ["onUpdate:modelValue"];
  var _hoisted_122 = { class: "input-group input-group-sm mb-3" };
  var _hoisted_13 = ["onUpdate:modelValue"];
  var _hoisted_14 = ["onUpdate:modelValue"];
  var _hoisted_15 = ["onClick", "disabled"];
  var _hoisted_16 = { class: "d-flex gap-2" };
  ...
  function render2(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_12, [
      ...
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList($setup.settings.repositories, (repo) => {
          return openBlock(), createBlock(
            ...
            null,
            {
              title: withCtx(() => [
                createTextVNode(
                  toDisplayString(repo.short_name) + " (" + toDisplayString(repo.full_name) + ") ",
                  1
                  /* TEXT */
                )
              ]),
              buttons: withCtx(() => [
                createBaseVNode("button", {
                  ...
                  onClick: ($event) => $setup.toggleStartup(repo),
                  disabled: $setup.blocked || !$setup.settings.changing_startup_allowed
                }, [
                  $setup.settings.startup_repositories.indexOf(repo.full_name) >= 0 ? (openBlock(), createElementBlock(
                    Fragment,
                    { key: 0 },
                    [
                      _cache[0] || (_cache[0] = createBaseVNode(
                      ...
                      _cache[1] || (_cache[1] = createTextVNode(" Loaded on startup "))
                    ],
                    64
                    /* STABLE_FRAGMENT */
                    ...
                    [
                      ...
                      _cache[3] || (_cache[3] = createTextVNode(" Not loaded on startup "))
                    ],
                    64
                    /* STABLE_FRAGMENT */
                  ))
                ], 8, _hoisted_22),
                $setup.settings.loading_new_allowed ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  class: "btn btn-danger btn-sm btn-circle",
                  onClick: ($event) => {
                    $event.stopPropagation();
                    $setup.unloadRepository(repo);
                  },
                  disabled: $setup.blocked
                }, [
                  createBaseVNode(
                    "i",
                    {
                      class: normalizeClass(["fa", $setup.deleting === repo.full_name ? ["fa-spinner", "fa-spin"] : ["fa-trash"]])
                    },
                    null,
                    2
                    /* CLASS */
                  )
                ], 8, _hoisted_32)) : createCommentVNode("v-if", true)
              ]),
              body: withCtx(() => [
                ...
                createBaseVNode("div", _hoisted_42, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": ($event) => repo.id_digits = $event,
                    type: "number",
                    class: "form-control"
                  }, null, 8, _hoisted_5), [
                    [vModelText, repo.id_digits]
                  ])
                ]),
                createBaseVNode("div", _hoisted_6, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": ($event) => repo.main_branch = $event,
                    type: "text",
                    class: "form-control"
                  }, null, 8, _hoisted_7), [
                    [vModelText, repo.main_branch]
                  ])
                ]),
                ...
                createBaseVNode("div", _hoisted_8, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": ($event) => repo.release_file = $event,
                    type: "text",
                    class: "form-control"
                  }, null, 8, _hoisted_9), [
                    [vModelText, repo.release_file]
                  ])
                ]),
                createBaseVNode("div", _hoisted_10, [
                  ...
                  withDirectives(createBaseVNode("input", {
                    "onUpdate:modelValue": ($event) => repo.release_script_path = $event,
                    type: "text",
                    class: "form-control"
                  }, null, 8, _hoisted_11), [
                    [vModelText, repo.release_script_path]
                  ])
                ]),
                ...
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList(repo.subontologies, (subontology) => {
                    return openBlock(), createElementBlock("div", _hoisted_122, [
                      ...
                      withDirectives(createBaseVNode("input", {
                        "onUpdate:modelValue": ($event) => subontology.excel_file = $event,
                        type: "text",
                        class: "form-control"
                      }, null, 8, _hoisted_13), [
                        [vModelText, subontology.excel_file]
                      ]),
                      ...
                      withDirectives(createBaseVNode("input", {
                        "onUpdate:modelValue": ($event) => subontology.release_file = $event,
                        type: "text",
                        class: "form-control"
                      }, null, 8, _hoisted_14), [
                        [vModelText, subontology.release_file]
                      ]),
                      createBaseVNode("button", {
                        class: "btn btn-danger",
                        onClick: ($event) => repo.subontology = repo.subontologies.filter((x) => x != subontology),
                        disabled: $setup.blocked
                      }, [..._cache[8] || (_cache[8] = [
                        createBaseVNode(
                          "i",
      ...
      createBaseVNode("div", _hoisted_16, [
        $setup.settings.loading_new_allowed ? (openBlock(), createElementBlock("button", {
          ...
          onClick: $setup.loadRepository,
          disabled: $setup.blocked
        }, [
          createBaseVNode(
            "i",
            {
              class: normalizeClass(["fa", $setup.loading ? ["fa-spinner", "fa-spin"] : ["fa-add"]])
            },
            null,
            2
            /* CLASS */
          ),
          _cache[15] || (_cache[15] = createTextVNode(" Load repository "))
  ...
  // js/settings/Settings.vue
  Settings_default.render = render2;
  Settings_default.__file = "js/settings/Settings.vue";
  Settings_default.__scopeId = "data-v-048866bb";
  ...
  // js/settings/main.ts
  var app = createApp(Settings_default2);

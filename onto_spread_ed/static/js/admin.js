...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/home/bjoern/development/onto-spread-ed/js/admin/Dashboard.vue?type=script
  var Dashboard_default = /* @__PURE__ */ defineComponent({
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { prefix_url, runScript, urls, scripts };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  });

  // sfc-template:/home/bjoern/development/onto-spread-ed/js/admin/Dashboard.vue?type=template
  var _hoisted_1 = { class: "row align-stretch" };
  var _hoisted_2 = { class: "col-sm-6 col-md-4 col-lg-3 m-2" };
  var _hoisted_3 = ["href"];
  var _hoisted_4 = { class: "col-sm-6 col-md-4 col-lg-3 m-2" };
  var _hoisted_5 = ["href"];
  var _hoisted_6 = {
    key: 0,
    class: "col-sm-6 col-md-4 col-lg-3 m-2"
  };
  var _hoisted_7 = ["href"];
  var _hoisted_8 = {
    key: 1,
  ...
  var _hoisted_9 = ["href"];
  var _hoisted_10 = { class: "row align-stretch" };
  var _hoisted_11 = { class: "dropdown m-2" };
      ...
      [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("a", {
              class: "card bg-light",
              href: $setup.urls.release,
              style: { "height": "100%", "text-decoration": "none", "border-width": "2px 2px 4px 2px" }
            }, _cache[0] || (_cache[0] = [
              createBaseVNode(
                "div",
                { class: "section p-5 text-center fs-2 bg-light" },
                [
                  createBaseVNode("i", { class: "fas fa-upload" })
                ],
                -1
                /* HOISTED */
              ),
              createBaseVNode(
                ...
                { class: "card-body" },
                [
                  createBaseVNode("h4", null, "Release"),
                  createBaseVNode("p", null, " Start the release process and release a new version of ontologies ")
                ],
                -1
                /* HOISTED */
              )
          ...
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("a", {
              ...
              createBaseVNode(
                ...
                { class: "section p-5 text-center fs-2 bg-light" },
                [
                  createBaseVNode("i", { class: "fas fa-folder-open" })
                ],
                -1
                /* HOISTED */
              ),
              createBaseVNode(
                ...
                { class: "card-body" },
                [
                  createBaseVNode("h4", null, "Rebuild index"),
                  createBaseVNode("p", null, " Force a complete rebuild of the index to ensure the search finds all entries. ")
                ],
                -1
                /* HOISTED */
              )
          ...
          "settings" in $setup.urls ? (openBlock(), createElementBlock("div", _hoisted_6, [
            createBaseVNode("a", {
              class: "card bg-light",
              href: $setup.urls.settings,
              style: { "height": "100%", "text-decoration": "none", "border-width": "2px 2px 4px 2px" }
            }, _cache[2] || (_cache[2] = [
              createBaseVNode(
                "div",
              ...
              createBaseVNode(
                ...
                { class: "card-body" },
                [
                  createBaseVNode("h4", null, "Repositories"),
                  createBaseVNode("p", null, " Add, remove, or edit repositories available on the editor. ")
                ],
                -1
                /* HOISTED */
              )
          ...
          "settings" in $setup.urls ? (openBlock(), createElementBlock("div", _hoisted_8, [
            createBaseVNode("a", {
              class: "card bg-light",
              href: $setup.urls.settings,
              style: { "height": "100%", "text-decoration": "none", "border-width": "2px 2px 4px 2px" }
          ...
          createBaseVNode("div", _hoisted_11, [
            ...
            createBaseVNode("ul", _hoisted_12, [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($setup.scripts, (script, key) => {
                  return openBlock(), createElementBlock("li", null, [
                    createBaseVNode("a", {
                      class: "dropdown-item",
                      href: "#",
                      onClick: ($event) => $setup.runScript(key)
                    }, [
                      _cache[4] || (_cache[4] = createBaseVNode(
                        "i",
                        { class: "fa-regular fa-circle-play text-success" },
                        null,
                        -1
                        /* HOISTED */
                      )),
                      createTextVNode(
                        " " + toDisplayString(script.title),
                        1
                        /* TEXT */
                      )
                    ], 8, _hoisted_13)
  ...
  // js/admin/Dashboard.vue
  Dashboard_default.render = render;
  Dashboard_default.__file = "js/admin/Dashboard.vue";
  var Dashboard_default2 = Dashboard_default;
  ...
  // js/admin/main.ts
  var app = createApp(Dashboard_default2);

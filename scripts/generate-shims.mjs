#!/usr/bin/env node
/**
 * Generates shim files for Vue and @ose/js-core that re-export from window globals.
...
// Dynamically import @ose/js-core to get all its exports
async function generateOseJsCoreShim() {
  ...
  const lines = [
    '// AUTO-GENERATED FILE - Do not edit manually!',
    '// Generated by scripts/generate-shims.mjs', 
    '// This shim re-exports @ose/js-core from window.OseJsCore for dynamically loaded plugin modules.',
    '',
